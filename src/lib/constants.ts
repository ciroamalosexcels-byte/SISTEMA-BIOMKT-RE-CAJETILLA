...
export const CONTENIDOS_CATEGORIAS: readonly {
  ...
  /** Tipo de ContentEvent que corresponde a esta categoría — usado para el ícono y para el punto verde de "subido hoy" (este último no aplica a Historias, ver clientes-view.tsx). */
