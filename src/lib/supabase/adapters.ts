...
export function adaptLead(row: LeadRow, stageMap: Map<string, string>): Lead {
  return {
    ...
    historiasHechas: row.historias_hechas ?? undefined,
    historiasContratadas: row.historias_contratadas ?? undefined,
    reelsHechos: row.reels_hechos ?? undefined,
    reelsContratados: row.reels_contratados ?? undefined,
    publicacionesHechas: row.publicaciones_hechas ?? undefined,
    publicacionesContratadas: row.publicaciones_contratadas ?? undefined,
...
export function adaptTeamMember(
  ...
  return {
    ...
    signoMaya: row.signo_maya ?? undefined,
    tonoMaya: row.tono_maya ?? undefined,
    colorMaya: row.color_maya ?? undefined,
    direccionMaya: row.direccion_maya ?? undefined,
    elementoMaya: row.elemento_maya ?? undefined,
